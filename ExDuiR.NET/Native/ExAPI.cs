...
namespace ExDuiR.NET.Native
{
    ...
    public struct ExBackgroundImageInfo
    {
        ...
        public IntPtr lpGrid;      //九宫矩形
        public IntPtr lpDelay;     //延时信息
    ...
    public struct ExReportListItemInfo
    {
        ...
        public IntPtr lParam;     //项目参数(同行共用)
    ...
    public struct ExReportListSortInfo
    {
        ...
        public IntPtr lpfnCmp;                    //LRESULT orderProc(HEXOBJ hObj,UINT nIndex1,LPVOID pvData1,UINT nIndex2,LPVOID pvData2,UINT nIndexCol,UINT nType,size_t lParam)
        public bool fDesc;                      //是否倒序
        public IntPtr lParam;                   //排序附加参数
    };
    ...
    public struct ExTreeViewNodeItem
    {
        ...
        public IntPtr pParent;     //父节点
        public IntPtr pPrev;       //上一个节点
        public IntPtr pNext;       //下一个节点
        public IntPtr pChildFirst; //第一个子节点
    ...
    {
        public IntPtr itemParent;      // 父项句柄（0为根项）
        public IntPtr itemInsertAfter; // 插入在此项之后（必须是同层）
        public int nID;                               // 项目ID
        public string pwzText;                       // 项目标题
        public IntPtr lParam;                         // 项目附加参数
    ...
    {
        public IntPtr imgNormal;        //图像.正常
        public IntPtr imgHover;         //图像.悬浮
        public IntPtr imgDownOrChecked; //图像.按下或者选中
    };
    ...
    {
        public IntPtr pDataObject; //数据对象指针IDataObject*
        ...
        public class ExAPI
    {
        ...
        public static extern bool Ex_LoadBitMapFromMemory(byte[] lpData, IntPtr dwLen, out IntPtr retBitMap);
        ...
        public static extern int Ex_DUIBindWindowEx(IntPtr hWnd, int hTheme, int dwStyle, IntPtr lParam, ExWndProcDelegate lpfnMsgProc);
        ...
        public static extern bool _canvas_fillroundedimage(int hCanvas, IntPtr hBrush, float left, float top, float right, float bottom, float radiuX, float radiuY, IntPtr shadowNum, int number, int crShadow);
        ...
        public static extern int _brush_createlinear_ex(float xs, float ys, float xe, float ye, IntPtr arrStopPts, int cStopPts);
        ...
        /// <returns></returns>
        [DllImport("libexdui.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, EntryPoint = "Ex_ObjInvalidateRect")]
        public static extern bool Ex_ObjInvalidateRect(int hObj, IntPtr rcRedraw);
        ...
        public static extern bool Ex_ObjSetBackgroundImage(int handle, byte[] lpImage, int dwImageLen, int X, int Y, int dwRepeat, IntPtr pRcGrids, int dwFlags, int dwAlpha, bool fUpdate);
        ...
        public static extern IntPtr Ex_ObjScrollGetControl(int hObj, int nBar);
        ...
        public static extern bool Ex_TrackPopupMenu(IntPtr hMenu, int uFlags, int x, int y, IntPtr nReserved, int handle, ref ExRect lpRc, ExWndProcDelegate pfnCallback, int dwFlags);
        ...
        public static extern bool Ex_ObjLayoutSet(int handle, IntPtr hLayout, bool fUpdate);
        ...
        public static extern IntPtr Ex_ObjGetFont(int hObj);
        ...
        public static extern IntPtr _imglist_add(IntPtr hImageList, byte[] lpImage, int cbImage, IntPtr nIndexInsert);
        ...
        public static extern bool _imglist_set(IntPtr hImageList, IntPtr nIndex, byte[] lpImage, int cbImage);
        ...
        public static extern IntPtr _img_savetomemory(int hImg, out byte[] lpBuffer);
        ...
        /// <returns>返回数据指针,注意自行释放,0表示失败</returns>
        [DllImport("libexdui.dll", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.StdCall, EntryPoint = "Ex_ObjGetDropData")]
        public static extern IntPtr Ex_ObjGetDropData(int hObj, int pDataObject, int dwFormat, out int pcbData);
