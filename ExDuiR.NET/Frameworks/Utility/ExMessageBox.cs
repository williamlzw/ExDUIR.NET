...
namespace ExDuiR.NET.Frameworks.Utility
{
    public class ExMessageBox
    {
        ...
        public static int ShowEx(IExBaseUIEle pOwner, string sText, string sCaption, int uType, string sCheckbox, ref bool pfChecked, int dwTimeout, int dwFlags, ExWndProcDelegate pfnWndProc = null)
        {
            int hOwner = pOwner == null ? 0 : pOwner.handle;
